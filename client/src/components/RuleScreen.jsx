...
export default function RuleScreen(props) {
  ...
  return (
    <div className="relative items-center justify-center bg-gray-200 border-4 border-dashed p-2">
        ...
        <h3 className="ml-4 py-2">1. You have 5 guesses to guess the mystery player of the day</h3>
        <ul className="ml-4 py-2">
            ...
            <li><i className="fa-solid fa-xmark text-red-800 ml-4"></i> means a mismatch</li>
        ...
        <h3 className="ml-4 py-2">3. A <span className='font-bold'>list of all possible players is provided</span>. After each guess, <span className="font-bold">invalid players will be removed</span> from the list based on the feedback, helping you narrow it down.</h3>
        <h3 className="ml-4 py-2">4. Invalid Guesses <span className="font-bold">DO NOT</span> count toward your guess total</h3>
    </div>
  )
}
